"""
Django settings for qa_qc_38508 project.
...
WSGI_APPLICATION = 'qa_qc_38508.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "qa_qc_38508 API",
    "DESCRIPTION": "API documentation for qa_qc_38508 App",
    "VERSION": "v1",
}
